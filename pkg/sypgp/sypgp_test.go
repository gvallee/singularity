...
func TestAskQuestion(t *testing.T) {
	...
	// Reposition to the begining to ensure there is something to read
	...
	restAnswer := testStr[len(firstAnswer)+1:len(testStr)]
	...
	output, questionErr = AskQuestion("Question test 4: ")
        ...
        fmt.Println (output)
	finalAnswer := restAnswer[len(secondAnswer)+2:len(restAnswer)] // We have to account for two \n
